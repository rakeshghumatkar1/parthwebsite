...
import { UPDATE_TYPE_LABELS } from "@/lib/public/updates";
...
export function UpdatesFilters({ projectOptions }: UpdatesFiltersProps) {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    router.push(`/updates${params.size ? `?${params.toString()}` : ""}`);
  }
    ...
    >
      ...
      <div>
        ...
        <select
          id="updateType"
          name="updateType"
          defaultValue={searchParams.get("updateType") ?? ""}
          className={inputClassName}
        >
