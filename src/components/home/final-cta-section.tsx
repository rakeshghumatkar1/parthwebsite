...
export function FinalCtaSection() {
  return (
    <section
      id="contact"
      className="bg-tb-navy text-tb-text-on-dark"
    >
      <div className="mx-auto w-full max-w-6xl px-6 py-16 text-center sm:px-8 sm:py-20 lg:py-24">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-tb-text-on-dark-muted sm:text-lg">
          ...
          the system, define the build, and create software that connects
        ...
        <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-tb-text-on-dark-muted sm:text-base">
          For larger or client-critical projects, delivery should include review,
          documentation, QA, security checks, and structured oversight through
          Think Big.
        </p>
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          ...
          <Button href="#proof-before-claims" variant="secondary" dark>
