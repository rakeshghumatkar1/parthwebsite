  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-tb-navy-deep via-tb-navy to-tb-navy text-tb-text-on-dark">
      <div
        ...
        aria-hidden
      />
      <div className="relative mx-auto grid w-full max-w-6xl gap-8 px-6 py-14 sm:px-8 sm:py-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-10 lg:py-20">
        <div className="max-w-xl lg:max-w-none">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-tb-cyan sm:text-sm">
            AI Software Systems
          </p>
          <h1 className="mt-4 text-balance text-3xl font-semibold leading-[1.1] tracking-tight text-white sm:text-4xl sm:leading-[1.08] lg:text-[2.65rem]">
            AI software systems, automation, and data workflows built around
            business use cases.
          </h1>
          <p className="mt-5 text-base leading-relaxed text-tb-text-on-dark sm:text-lg">
          ...
          <div className="mt-4 space-y-3 text-sm leading-relaxed text-tb-text-on-dark-muted sm:text-base">
            <p>
