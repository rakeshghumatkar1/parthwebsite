...
export const MODULE_GUIDANCE: Record<ModuleKey, ModuleGuidance> = {
  ...
  media: {
    title: "Media Library",
    subtitle: "URL-only metadata for images, PDFs, thumbnails, and documents.",
    status: "url-only",
    statusNote: "Upload not built yet",
    listHelpTitle: "What Media Library is for",
    listHelpBullets: [
      "Stores approved public URLs — no upload button yet.",
      "Required: file URL. Alt text helps accessibility for images.",
      "Image role = how the file is used. Display mode = visual treatment.",
      "Future uploads use parthwebsite/ prefix. Never touch other sites' files.",
    ],
    listNextAction: "Add media URLs when approved files are hosted publicly.",
    emptyTitle: "No media records yet",
    emptyDescription: "Media holds URLs used across the CMS.",
    emptyWaitNote: "Paste URLs only — do not upload here yet.",
    whereAppears: ["Project covers and galleries", "Proof attachments", "Video thumbnails", "Future public pages"],
    formIntro: "Paste an approved file URL. Upload comes later with parthwebsite/ prefix.",
  },
};
